...
namespace MarkovLibraryCSharp
{
    internal class Program
    {
        ...
        {
            var initialnumSpins = 8;   //Initial number of Free spins
            var retriggernumSpins = 0; // Retrigger free spins
            var maxSpins = 300;        // Max free spins
            double pRetrigger = 0;
            var anotherRun = "y";
        ...
        private static double markovPlayWSS(int initialnumSpins, int retriggernumSpins, int maxSpins, double pRetrigger)
        {
            pRetrigger = 0.00260363321417124000; //0.01333149492017420000;
            var p2 = 0.000116711325743665000;    // 0.01057155297532660000;
            var p3 = 0.000004291990876288470;    // 0.00293185776487663000;
            var p4 = 0.000008218475621;          //SS 3trigger
            var p5 = 0.000000000934407;          //SS 4trigger
            var p6 = 0.000000000000032;          //SS 5trigger
            ...
            var i = 0;
            retriggernumSpins = 8;
            var retriggernumSpins2 = 16;
            var retriggernumSpins3 = 32;
            //maxSpins = 100;
            //initialnumSpins = 3;

            var TG = new TransitionGraph<int>(); // Class Transition Graph Plus
